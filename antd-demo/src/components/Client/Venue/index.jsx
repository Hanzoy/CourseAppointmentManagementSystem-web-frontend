...
class Avatar extends React.Component {
    ...
    constructor(props) {
        ...
        if (props.record.url !== null) {
            this.state.imageUrl = props.record.pictureUrl;
        }
    }
    handleChange = info => {
...
class Index extends Component {
    ...
    async componentDidMount() {
        ...
        this.setState({dataSource: result.data.venueInfo, count:result.data.venueInfo.length})
    }

    handleDelete = async record => {
        const dataSource = [...this.state.dataSource];
        await deleteVenue({id:record.id});
    ...
    handleAdd = async () => {
        ...
        const result = await addVenue({name:`name ${count}`, address: `address ${count}`});
        const newData = {
            key: count,
            id: result.data.id,
            name: `name ${count}`,
